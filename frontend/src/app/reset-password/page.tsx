  ...
  return (
    <div className="w-full max-w-md animate-slide-up">
      <div className="text-center mb-8">
        ...
        <p className="mt-2 text-sm text-slate-400">Complete credentials override update</p>
      </div>
      ...
      <div className="glass-panel rounded-2xl p-8 shadow-2xl relative">
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {!token && (
              <div className="p-4 rounded-lg bg-rose-500/10 border border-rose-500/20 text-xs text-rose-300 font-medium mb-4">
                Warning: Reset token not found. Please click the link directly from your password reset email.
              </div>
            )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="glass-input block w-full pl-10 pr-4 py-2 rounded-lg text-sm text-white placeholder-slate-500 disabled:opacity-50"
                  placeholder="••••••••"
                />
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-2.5 px-4 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-sm font-semibold text-white shadow-lg active:translate-y-[1px] disabled:opacity-50 disabled:pointer-events-none transition-all flex items-center justify-center gap-2 mt-4"
            >
              {loading ? (
                <>
    ...
    <div className="relative min-h-screen flex items-center justify-center p-4 overflow-hidden">
      ...
      <Suspense fallback={
        <div className="text-center py-8">
          ...
          <p className="text-sm text-slate-300 mt-4">Loading reset context...</p>
        </div>
      }>
